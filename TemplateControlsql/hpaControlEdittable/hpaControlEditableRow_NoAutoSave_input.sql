...
-- =====================================================
-- NO AutoSave với INPUT (Type 1) - Batch Save
-- =====================================================
...
BEGIN
    ...
    SET @html = N'
        <style>
            ...
            th.col-status { width: 50%; }
            .hpa-editable-row.editing {
                box-shadow: 0 0 0 2px rgba(239, 108, 0, 0.5) !important;
            }
        </style>
        
        <h2 class="mb-4">Không AutoSave - Type 1 (Input text)</h2>
        <p>Sửa nhiều → bấm nút lưu batch</p>
                            ...
                            <template class="editFormTemplate" onclick="hpaControlEditTableRowNoAutoSave(event)" 
                                ...
                                <div class="position-relative w-100">
                                    <input type="text" class="form-control form-control-sm edit-input w-100 rounded py-1 px-2"
                                        style="display: none; border: 1px solid #ef6c00 !important;" 
                                        oninput="hpaControlEditTableRowNoAutoSave(event)" 
                                        onkeydown="hpaControlEditTableRowNoAutoSave(event)">
